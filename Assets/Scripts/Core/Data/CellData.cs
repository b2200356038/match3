...
namespace Game.Core.Data
{
    public struct CellData
    {
        ...
        public static CellData CreateCube(CubeType cubeType, Vector2Int position, bool canFall = true,
        ...
        public static CellData CreateObstacle(ObstacleType obstacleType, Vector2Int position, int health = 1,
            bool canFall = false, CellState state = CellState.Idle)
        {
            return new CellData(position, state)
            {
        ...
        public bool IsReadyToFall => CanFall && State == CellState.Idle;
